The **First International Workshop on Challenges in Artificial Intelligence and Machine Learning for Internet of Things (AIChallengeIoT 2019)** will be held in conjunction with [ACM SenSys 2019](http://sensys.acm.org/2019/) on November 10-13, 2019 in New York, NY, USA.
...
Submitted papers should be previously unpublished and not currently under review by another conference or journal. As an exception, demo and poster papers that are submitted to the main SenSys conference are allowed to submit to this workshop at the same time, but they will not be included in the workshop proceedings if they are accepted by the main SenSys conference (see note below).
